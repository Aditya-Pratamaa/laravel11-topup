        ...
        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <div class="wg-filter flex-grow">
                    <form action="{{ route('admin.categories') }}" method="GET" class="form-search">
                        <fieldset class="name">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pname">
                                    <div class="image">
                                        <img src="{{ asset('uploads/categories/' . $category->image) }}" alt="{{ $category->name }}" width="50" height="50">
                                    </div>
                                    <div class="name">
